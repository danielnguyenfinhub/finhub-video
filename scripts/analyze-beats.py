# Copied unchanged (apart from this header) from heygen-com/hyperframes,
# skills/music-to-video/scripts/analyze-beatgrid.py at commit 77b2260,
# Apache-2.0: see scripts/third_party/HYPERFRAMES-LICENSE.txt.
# finhub-video: run it with the OmniVoice venv's Python (it already has
# librosa, numpy and soundfile), e.g.
#   .omnivoice\venv\Scripts\python.exe scripts/analyze-beats.py public/music/bed.mp3 -o public/music/bed.audiomap.json
# src/elements/beats.ts reads the result.
