...
// Loads Be Vietnam Pro (600/800/900) once per page. Components that measure
// text (measureText/fitText) before painting can await it too.
let reelFont: Promise<unknown> | null = null;
export const reelFontReady = () =>
  (reelFont ??= Promise.all(
    (
      [
        ["600", "SemiBold"],
        ["800", "ExtraBold"],
